...
def chunk_nda_fwd_kernel_intra_token_parallel(
    q,
    k,
    g,
    beta,
...
def chunk_nda_fwd_intra_token_parallel(
    q: torch.Tensor,
    k: torch.Tensor,
    gk: torch.Tensor,
    beta: torch.Tensor,
    ...
    chunk_nda_fwd_kernel_intra_token_parallel[grid](
        q=q,
        k=k,
        g=gk,
        beta=beta,
